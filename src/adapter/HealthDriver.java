...
public class HealthDriver {
     ...
     */
    public void run() {
        MedicalRecord medRecord = new SCMedicalRecord(
            "Amy", 
            "Smith", 
            makeDate(2010, 3, 21), 
            Gender.FEMALE);
        ...
        HealthRecord record = new CarolinaHealthRecord(
            "Bob", 
            "White", 
            makeDate(2008, 8, 10), 
            "Male");
        ...
        record.addHistory(makeDate(2008, 11, 28), 
            false, 
            "Suffering from the croup, gave sterroids");
